<template>
  <footer>
    <div style="display: flex; background: #111">
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 100" preserveAspectRatio="none" style="position: relative; z-index: 10; background-color: #191919">
        <path
          class="wavePath2"
    ...
    <div style="position: relative; z-index: 10; background: #591f82; min-height: 390px">
      <div class="cREEJR">
        ...
        <div>
          ...
          <!--<a href="/en/contact" class="OvJlu">Contact</a>-->
        </div>
        <div>
...
<style scoped>
/*!sc*/
@-webkit-keyframes waveDividerAnimation {
  0% {
    d: path(
...
/*!sc*/
.wavePath2 {
  -webkit-animation: waveDividerAnimation 20s linear infinite alternate;
  -webkit-animation: waveDividerAnimation 20s linear infinite alternate;
